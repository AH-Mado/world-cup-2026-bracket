...
const dict = {
  en: {
    ...
    stat_saves:         'Saves',
    stat_passes:        'Passes',
    stat_accurate_passes: 'Accurate passes',
    stat_pass_accuracy: 'Pass accuracy',
    stat_crosses:       'Crosses',
  ...
  ar: {
    ...
    stat_saves:         'التصديات',
    stat_passes:        'التمريرات',
    stat_accurate_passes: 'التمريرات الدقيقة',
    stat_pass_accuracy: 'دقة التمرير',
    stat_crosses:       'العرضيات',
    stat_tackles:       'التدخلات',
    stat_interceptions: 'الاعتراضات',
  },
};
